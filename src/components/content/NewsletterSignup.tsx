        ...
        <div className="grid gap-8 lg:grid-cols-[1fr_minmax(0,460px)] lg:items-center lg:gap-16">
          <div>
            ...
            <p className="mt-3 max-w-xl text-[1.0625rem] leading-relaxed text-accent-soft">
              A monthly digest of new research, documented use cases, datasets, events and opportunities from across
              South and Southeast Asia. No more than one email a month.
            </p>
          </div>
