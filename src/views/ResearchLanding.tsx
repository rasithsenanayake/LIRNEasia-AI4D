...
export function ResearchLanding() {
  return <Container className="py-12">
    <SectionHeading eyebrow="Research & insights" title="Evidence, analysis and commentary" description="Browse all publication types in the proposed research architecture." action={<LinkButton to="/explore?group=publications" variant="secondary">Browse repository</LinkButton>} />
